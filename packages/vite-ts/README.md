# xc-web-update-notice-vite-ts

Vite TypeScript 版本的前端版本检测通知插件。

## 📥 安装

```bash
npm install xc-web-update-notice-vite-ts
```
...
import XcUpdateNoticeVitePlugin from 'xc-web-update-notice-vite-ts';
...
| `customVersionName`       | `string`  | `_version`       | 客户端版本缓存名称                     |                 |
...
| `laterText`     | `string`  | `稍后更新` | "稍后更新"按钮文本                 |                     |
| `okText`        | `string`  | `立即更新` | "立即更新"按钮文本                 |                     |
...
| `_laterInfo`      | `function` | 获取"稍后更新"的版本信息列表                                                           |
...
- [xc-web-update-notice-vite](https://www.npmjs.com/package/xc-web-update-notice-vite) - Vite JavaScript 版本
